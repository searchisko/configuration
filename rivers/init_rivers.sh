...
## This script uses Elasticsearch 'search' cluster node http connector to init all rivers defined in this folder.
##
...
echo "Go to init rivers into Elasticsearch: ${esurlbase}"
